...
.besv p{  
 ...
 height:110px;
 padding: 50px;
 background-image:  linear-gradient( 180deg, #AFBBF2, #bfc9f7 100%);
 bottom:-18px;
}
.besv p i{
  color: #AB5F95;
...
.besv a{
  ...
  color: #000000;
    ...
    <div class="wrapper">
        ...
        <div class=image > <img src="/project memoir/img/pexel.png" ></div>

    </div>
    <div class="besv">
                <p><a href="issam.php">Blom<i class="fab fa-google-wallet"></i>Shop </a>,meilleur magasin de vêtements en ligne</p>
