...
if(isset($_POST['signup'])){
	if(empty($username) || empty($password)|| empty($email)|| empty($contry)){
		echo '<script> alert("please fill al gaps")</script>';
	}
else{
	$insert_c ="insert into customers (username,password,email,contry,ip)  values ('$username','$password','$email','$contry','$ip')";
 ...
 if(isset($_POST['login'])){
   if(empty($username) || empty($password)){
	...
	if($user!=$username && $pass!=$password){
		...
		echo'<script> alert("there id no")</script>';
